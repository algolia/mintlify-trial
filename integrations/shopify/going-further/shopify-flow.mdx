...
1. Activate the **Top Searches** trigger.
   ...
   ![Select the Top searches trigger in the Shopify Flow app](/doc/assets/images/integrations/shopify/going-further/13-shopify-flow-tab-461f714a.jpeg)
...
1. Click **Create workflow**.
   ...
   ![Shopify Flow app with create workflow button](/doc/assets/images/integrations/shopify/shopify-flow-9f54845b.png)

1. Click **Select trigger**, find the **Algolia AI Search & Discovery** app,
   and select the **Top Searches** trigger.

   ![Select the Top searches trigger for your workflow in the Shopify Flow app](/doc/assets/images/integrations/shopify/select-trigger-60647f2d.png)
...
1. In the Shopify Flow app, click **Add action**.
   ...
   ![Connect your Slack workspace with your Shopify store](/doc/assets/images/integrations/shopify/add-action-5cbe9af3.png)

1. Find the **Slack** app.

1. If it's your first time using the Slack action in Shopify, click **Connect**.

   ![Connect your Slack workspace with your Shopify store](/doc/assets/images/integrations/shopify/slack-action-60487bce.png)

1. Select the **Send Slack message** action.

   ![Select the Send Slack message action in the Shopify Flow app](/doc/assets/images/integrations/shopify/slack-action-connected-d0a71953.png)

1. Enter the details for your Slack message:

   ![Format your Slack message action](/doc/assets/images/integrations/shopify/slack-message-84be15b9.png)
...
1. Click **Turn on workflow**.
   ...
   ![Turn on the workflow](/doc/assets/images/integrations/shopify/turn-on-workflow-085485dc.png)
...
1. In the Shopify Flow app, select your workflow and add another action.
   ...
   ![Add another action to an existing workflow](/doc/assets/images/integrations/shopify/add-more-action-26cdf781.png)

1. From the Shopify app, select the **Send internal email** action.

   ![Configure the Send internal email action](/doc/assets/images/integrations/shopify/send-internal-email-e46b9e79.png)

1. Enter the details for your email.

   ![Configure the email](/doc/assets/images/integrations/shopify/email-13569071.png)
