...
![The Collection pages enable screen in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/1-enabling-collection-pages-2219b377.jpeg)
...
![The Collection pages reindexing screen in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/2-collection-pages-reindexing-a31eb758.jpeg)
...
![The Collection pages display settings in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/3-collection-pages-display-settings-58289cc9.jpeg)
...
![The Collection pages sort orders settings in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/4-collection-pages-sort-orders-397fab43.jpeg)
...
![The Collection pages facets settings in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/5-collection-pages-facets-2c6bf181.jpeg)
...
1. **Add a facet:**
   ...
   ![The Collection add facets settings in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/13-collection-add-facet-c4bfbc53.png)

   ![The Collection edit facets settings in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/14-collection-edit-facet-8e2e89a4.png)
...
1. **Change the category page identifier:**
   ...
   ![The Collection category page identifier configuration](/doc/assets/images/integrations/shopify/collection-pages/15-collection-category-page-identifier-17c65818.png)
...
1. **Change your frontend code:**
   ...
   ![Viewing the network tab of the Collection page](/doc/assets/images/integrations/shopify/collection-pages/16-collection-page-network-c8a23572.png)

## Turn off Algolia on collection pages

![The Collection pages facets settings in the Shopify admin](/doc/assets/images/integrations/shopify/collection-pages/6-collection-pages-disable-f7bb19c8.jpeg)
