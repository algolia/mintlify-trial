...
1. In your Shopify admin, go to **Online store > Themes**, select the theme you want to update, and click **Edit code**.
   ...
   ![Shopify theme library code editor](/doc/assets/images/integrations/shopify/edit-theme-code-5d877a8a.png)
...
1. Open the **Layouts** folder and open the `theme.liquid` file. Locate the line for including `algolia_config.js`.
   ...
   ![algolia\_config.js](/doc/assets/images/integrations/shopify/theme-liquid-alglia-config-c3ed213b.png)
...
1. Save your updates.
   ...
   ![Save theme](/doc/assets/images/integrations/shopify/save-theme-b5053573.png)
