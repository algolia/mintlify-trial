...
description: |-
  Learn about SKU reindexing form in the Algolia extension for Magento 2.
---
...
It might happen that for some reason, you may need to index one or many products to Algolia immediately, without waiting for [the indexing queue](/integration/magento-2/how-it-works/indexing-queue/).
...
To reindex products, you have to copy/paste their SKUs separated by commas or carriage returns and click **Reindex SKU(s)** on the top-right corner of the page.
