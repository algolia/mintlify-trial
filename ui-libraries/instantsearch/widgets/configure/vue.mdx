...
<code>&lt;ais-configure<br />&nbsp;&nbsp;&nbsp;&nbsp;// Optional parameters<br />&nbsp;&nbsp;&nbsp;&nbsp;:<a href="#options">searchParameters</a><br />/&gt;</code>
...
<CardGroup cols={4}>
    <Card title="Live example" icon="eye" href="https://instantsearchjs.netlify.app/stories/vue/?selectedKind=ais-configure" horizontal="true" />
</CardGroup>

Import it as a component or with a plugin.
