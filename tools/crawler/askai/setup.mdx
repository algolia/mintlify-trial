...
sidebarTitle: Set up
description: |-
  Learn how to enable Ask AI, configure it, and add it to your site.
---
...
1. Follow the prompts to configure Ask AI.
...
For more information about how to add the Ask AI assistant to your site, you can:

- Use the [DocSearch UI integration](link: DocSearch UI integration guide).
- Create a custom implementation that calls the [Generate a response](/tools/crawler/askai/public/generate-an-ai-powered-response) endpoint.
