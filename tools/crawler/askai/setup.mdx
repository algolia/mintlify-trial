...
title: "Set up Ask AI"
sidebarTitle: "Set up"
description: "Learn how to enable Ask AI, configure it, and add it to your site."
---

To use Ask AI, you need to enable the feature, add your domains, create a configuration, define LLM prompts, and add the AI assistant to your site.

## Enable the feature

1. Sign in to the [Algolia dashboard](https://dashboard.algolia.com/users/sign_in).
2. On the left sidebar, select **Data sources**.
3. Select [**Crawler**](https://dashboard.algolia.com/crawler).
4. Click **Ask AI** and then **Enable**.
5. Follow the prompts to configure Ask AI.
...
2. On the left sidebar, select **Data sources**.
3. Select [**Crawler**](https://dashboard.algolia.com/crawler).
4. Click **Ask AI** and then **Create configuration**.
...
Ask AI includes three default prompt templates.
You can customize them or create new ones to define the assistant's tone, format, and response style.
...
To add the Ask AI assistant to your site, you can:

- Use the [DocSearch UI integration](link: DocSearch UI integration guide).
- Create a custom UI that calls the [Generate a response](/tools/crawler/askai/public/generate-an-ai-powered-response) endpoint.

<Note>
  **Editor's note.**

  - First item in DocSearch docs?
  - Second item needs some expansion?
</Note>