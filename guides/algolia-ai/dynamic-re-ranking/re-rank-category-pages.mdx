...
No coding is required to enable **Dynamic Re-Ranking on category pages**.

Learn more about [Dynamic Re-Ranking's effect on relevance](//guides/algolia-ai/re-ranking/#effect-on-relevance).

## Implementation steps

1. Build the [category pages](https://www.algolia.com/doc/guides/solutions/ecommerce/browse/tutorials/category-pages/)
1. Send click and conversion events to Algolia
1. Enable Dynamic Re-Ranking on category pages
1. A/B test Dynamic Re-Ranking on category pages
...
<CardGroup cols={2}>
  ...
  <Card title="Guide" icon="book" href="/guides/algolia-ai/re-ranking/#security-best-practices" horizontal="true">
...
By default, the [event freshness](/guides/algolia-ai/re-ranking/#give-more-weight-to-recent-events-event-freshness) setting is enabled to handle seasonality and shorter trends.
...
![Screenshot of the Dynamic Re-Ranking simulator](/images/ai/solutions-browse-reranking-choose-browse-facet.jpg)
