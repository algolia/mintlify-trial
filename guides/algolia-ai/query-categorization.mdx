...
<Note>
  The automatic filtering and boosting preview shows how promotion [rules](/guides/managing-results/rules/rules-overview/) and [Dynamic Re-Ranking](/guides/algolia-ai/re-ranking/) affect results.
