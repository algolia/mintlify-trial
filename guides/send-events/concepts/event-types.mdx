...
import NeuralsearchEvents from '/snippets/insights/neuralsearch-events.mdx';
...
import FrequentlyboughttogetherEvents from '/snippets/insights/frequentlyboughttogether-events.mdx';
...
import RelatedproductsEvents from '/snippets/insights/relatedproducts-events.mdx';
...
import TrendingEvents from '/snippets/insights/trending-events.mdx';
...
import DrrEvents from '/snippets/insights/drr-events.mdx';
...
import QcatEvents from '/snippets/insights/qcat-events.mdx';
...
- You're sending [emails with recommendations](https://www.algolia.com/developers/code-exchange/showcase/personalized-email-recommendations/).
