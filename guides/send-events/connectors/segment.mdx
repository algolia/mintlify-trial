...
1. Select the source you want to set up and click **Add Destination**.

    ![Add a destination to a source](/images/segment/1-sources.png)

1. Search for the Algolia destination and select it to add it.
...
1. Copy your application ID and search API key [from the dashboard](https://dashboard.algolia.com/account/api-keys/) and paste it into Segment.

    ![Add your Algolia credentials](/images/segment/3-configuration.png)

For more information about adding destinations, comsult the Segment documentation.
