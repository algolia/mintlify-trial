...
1. On the [**Connectors**](https://dashboard.algolia.com/connectors/) page,
   select the [**Google Analytics 4 BigQuery Export**](https://dashboard.algolia.com/connectors/google-analytics-4-bq-export/create)
   and click **Connect**.
