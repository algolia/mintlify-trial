...
For effective [personalization](/doc/guides/personalization/classic-personalization/what-is-personalization/), you need to identify users across sessions.
It's best to use an identifier from your authentication,
user profile, or ecommerce service after users signed in. For more information, see [User token](/doc/guides/sending-events/concepts/usertoken/).
