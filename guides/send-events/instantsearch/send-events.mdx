...
import ClickEvent1 from '/snippets/insights/generic-click-event-1.mdx';
...
import ClickEvent2 from '/snippets/insights/generic-click-event-2.mdx';
...
import ClickEvent3 from '/snippets/insights/generic-click-event-3.mdx';
...
import ClickEvent4 from '/snippets/insights/generic-click-event-4.mdx';
