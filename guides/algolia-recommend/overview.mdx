...
This model [can be set up in a few minutes](/guides/algolia-recommend/how-to/lookingSimilar/) as it **doesn't require any events**.
...
<CardGroup cols={2}>
  ...
  <Card title="Guide" icon="book" href="/guides/algolia-recommend/how-to/rules/" horizontal="true">
    Recommend Rules
  </Card>
</CardGroup>
